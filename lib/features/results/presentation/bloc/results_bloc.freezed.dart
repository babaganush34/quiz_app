...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ResultsEvent);
}
...
/// @nodoc
class $ResultsEventCopyWith<$Res>  {
$ResultsEventCopyWith(ResultsEvent _, $Res Function(ResultsEvent) __);
}


/// Adds pattern-matching-related methods to [ResultsEvent].
extension ResultsEventPatterns on ResultsEvent {
...
class _Started implements ResultsEvent {
  const _Started();
...
/// @nodoc
class $ResultsStateCopyWith<$Res>  {
$ResultsStateCopyWith(ResultsState _, $Res Function(ResultsState) __);
}
...
class _Initial implements ResultsState {
  const _Initial();
